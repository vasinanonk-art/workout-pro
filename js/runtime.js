...
function uiPolishAddVersionPanel(){
 try{
  ...
  // Updated version panel for v5.3.3. Reflects current build and patch notes.
  d.innerHTML='<div class="section-title">Build / QA</div><div class="msg info">Version: <b>v5.3.3</b><br>Build: Lite Date & Save Patch + Final Fix<br>QA: Heavy recomputations disabled; date always synchronized</div>';
...
function modernUiHeader(){
 try{
   ...
   // Display the current app version in the Modern UI header.  Updated to v5.3.3 in the lite patch.
   hero.innerHTML='<div style="display:flex;justify-content:space-between;gap:12px;align-items:center;flex-wrap:wrap"><div><div style="font-size:28px;font-weight:800">Workout PRO</div><div style="opacity:.8;margin-top:4px">Modern Hypertrophy & Recovery System</div></div><div><span class="status-pill status-good">v5.3.3</span><span class="status-pill status-warn">Modern UI</span></div></div>';
   main.prepend(hero);
 }catch(e){console.warn(e)}
}
